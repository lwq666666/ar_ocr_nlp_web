        ...
        <el-main style="height:680px">
            <el-form ref="form" :model="form" label-width="200px" style="padding:70px">
                ...
                <el-form-item :inline="true" label="请上传解题过程:">
                    ...
                    <el-button style="margin-top: 10px" size="small" type="primary" @click="submitUpload">识图开始
                    </el-button>
                </el-form-item>
                    ...
                    <el-table :data="answer" style="width: 100%" :row-class-name="tableRowClassName">
                        ...
                        <el-table-column prop="result" label="批改结果" width="180">
                            <template slot-scope="scope">
                                ...
                                <i v-else-if="scope.row.result==false" class="el-icon-close" style="color:red"></i>
        ...
        methods: {
            marking() {
                ...
                for (var i = 0; i < this.answer.length; i++) {
                    array=this.answer[i].text;
                }
                var answer = array;
                // answer = answer.replace(/\"/g, "");

                marking(answer, this.form.problem).then(response => {
            ...
            handleAvatarSuccess(res, file) {
                ...
                for (var i = 0; i < res.data.result.length; i++) {
                    this.answer.push({text: res.data.result[i], result: null});
                }
            },
